...
namespace TestMod
{
    ...
    /// - Only lifecycle methods (Awake, Update, OnDestroy)
    ...
    /// </summary>
    [BepInPlugin("TestMod.TestMod", "TestMod", "1.0.0")]
    public class Main : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            try
            {
                ...
                Logger.LogInfo("TestMod initialized successfully");
            }
            catch (System.Exception ex)
            {
                Logger.LogError($"Failed to initialize TestMod: {ex.Message}");
