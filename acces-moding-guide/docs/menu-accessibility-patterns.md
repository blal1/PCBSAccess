...
=====================
- [menu-accessibility-checklist.md](menu-accessibility-checklist.md) - Quick checklist before implementation
- [state-management-guide.md](state-management-guide.md) - Handler architecture, multiple handlers
- [ACCESSIBILITY_MODDING_GUIDE.md](ACCESSIBILITY_MODDING_GUIDE.md) - General accessibility patterns
- [unity-reflection-guide.md](unity-reflection-guide.md) - Accessing private fields for UI inspection
