...
=====================
- [menu-accessibility-patterns.md](menu-accessibility-patterns.md) - Detailed patterns, code examples, label resolution
- [state-management-guide.md](state-management-guide.md) - Handler architecture, debug mode
