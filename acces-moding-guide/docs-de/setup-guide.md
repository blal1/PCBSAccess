...
**Den gewählten Mod-Loader** in [project_status.md](project_status.md) festhalten — er beeinflusst die Projektstruktur, Build-Konfiguration und Code-Templates.
...
- Siehe [localization-guide.md](localization-guide.md) für vollständige Anleitung
...
- Erstelle [project_status.md](project_status.md) mit den gesammelten Infos (Spielname, Pfade, Architektur, Erfahrungslevel)
...
**Bei Crashes oder stillem Fehlschlagen:** Lies [technical-reference.md](technical-reference.md) Abschnitt "KRITISCH: Zugriff auf Spielcode".
...
1. C#-Projekt mit Mod-Loader-Referenzen erstellen (MelonLoader oder BepInEx — siehe [technical-reference.md](technical-reference.md) für beide)
...
3. Bei Menüs: [menu-accessibility-checklist.md](menu-accessibility-checklist.md) durcharbeiten
...
Siehe [ACCESSIBILITY_MODDING_GUIDE.md](ACCESSIBILITY_MODDING_GUIDE.md) für Code-Patterns.
